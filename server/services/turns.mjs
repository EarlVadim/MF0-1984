...
export async function listTurns(dialogId) {
  return adapter.all(
    `SELECT id, user_text, user_attachments_json, assistant_text, requested_provider_id, responding_provider_id, responding_model_id, request_type, user_message_at, assistant_message_at,
