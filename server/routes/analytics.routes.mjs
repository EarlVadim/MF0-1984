...
router.get("/analytics/turn-costs/:turnId", (req, res) => {
  ...
  const turn = db.prepare(
    `SELECT id, dialog_id, request_type, requested_provider_id, responding_provider_id, responding_model_id,
  ...
  const modelId = String(turn.responding_model_id ?? "").trim() || null;
